 ...
 * File Name: JSON.cpp
 *
 * Description: source file for the JsonHandler Class
 *
 * Author: Mohamed Adel
 *******************************************************************************/
#include "JSON.h"
...
JsonHandler::JsonHandler(QObject *parent)
    : QObject{parent}
{
    Users_DB.setFileName("C:/Users/HP/Desktop/Final_Project--ClientServer"
                         "/Server_Final_Project_ITIDA/DataBase/Bank_DB.json");
    Login_DB.setFileName("C:/Users/HP/Desktop/Final_Project--ClientServer"
                         "/Server_Final_Project_ITIDA/DataBase/Login.json");
}
